...
export class DepartmentComponent implements OnInit {
  ...
  async getItems() {
    ...
    this.items.next(await this.innowayApi.department.getList({ query }));
    this.itemCount = this.innowayApi.department.pagination.totalItems;
  ...
  async deleteItem(item) {
    ...
    try {
      ...
      await this.innowayApi.department.delete(item.id);
  ...
  async export() {
    ...
    const listData = await this.innowayApi.department.getList({ query });
