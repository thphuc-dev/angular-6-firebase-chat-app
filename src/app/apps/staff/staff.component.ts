...
export class StaffComponent implements OnInit {
  ...
  async getItems() {
    ...
    this.items.next(await this.innowayApi.staff.getListStaffs({ query }));
  ...
  async deleteItem(item) {
    ...
    try {
      ...
      await this.innowayApi.staff.deleteStaff(item.id);
  ...
  async export() {
    ...
    const listData = await this.innowayApi.staff.getList({ query });
