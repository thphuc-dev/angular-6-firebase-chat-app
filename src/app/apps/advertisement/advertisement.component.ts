...
export class AdvertisementComponent implements OnInit {
  ...
  async getItems() {
    ...
    this.items.next(await this.innowayApi.advertisement.getList({ query }));
    this.itemCount = this.innowayApi.advertisement.pagination.totalItems;
  ...
  async deleteItem(item) {
    ...
    try {
      ...
      await this.innowayApi.advertisement.delete(item.id);
  ...
  async export() {
    ...
    const listData = await this.innowayApi.advertisement.getList({ query });
