...
export class RaceComponent implements OnInit {
  ...
  async getItems() {
    ...
    this.items.next(await this.innowayApi.race.getList({ query }));
    this.itemCount = this.innowayApi.race.pagination.totalItems;
  ...
  async deleteItem(item) {
    ...
    try {
      ...
      await this.innowayApi.race.delete(item.id);
  ...
  async export() {
    ...
    const listData = await this.innowayApi.race.getList({ query });
