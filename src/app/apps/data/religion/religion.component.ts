...
export class ReligionComponent implements OnInit {
  ...
  async getItems() {
    ...
    this.items.next(await this.innowayApi.religion.getList({ query }));
    this.itemCount = this.innowayApi.religion.pagination.totalItems;
  ...
  async deleteItem(item) {
    ...
    try {
      ...
      await this.innowayApi.religion.delete(item.id);
  ...
  async export() {
    ...
    const listData = await this.innowayApi.religion.getList({ query });
