...
export class MajorComponent implements OnInit {
  ...
  async getItems() {
    ...
    this.items.next(await this.innowayApi.major.getList({ query }));
  ...
  async deleteItem(item) {
    ...
    try {
      ...
      await this.innowayApi.major.delete(item.id);
  ...
  async export() {
    ...
    const listData = await this.innowayApi.major.getList({ query });
