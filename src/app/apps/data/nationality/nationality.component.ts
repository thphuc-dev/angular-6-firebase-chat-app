...
export class NationalityComponent implements OnInit {
  ...
  async getItems() {
    ...
    this.items.next(await this.innowayApi.nationalities.getList({ query }));
    this.itemCount = this.innowayApi.nationalities.pagination.totalItems;
  ...
  async deleteItem(item) {
    ...
    try {
      ...
      await this.innowayApi.nationalities.delete(item.id);
  ...
  async export() {
    ...
    const listData = await this.innowayApi.nationalities.getList({ query });
